...
let app1a = new App("App1", "Descrion tralala", 5, 3),
    app1b = new App("App1", "Descrion tralala 2", 6, 8),
    app1c = new App("App1", "Descrion tralala 3", 4, 9),
    // app1d = new App("App1", "Descrion tralala 3", 4, 11),
    app2 = new App("App2", "Descripo2 tralala", 1, 2),
    app3 = new App("App3", "Descripo2 tralala", 1, 2),
    app4 = new App("App4", "Descrip2 tralala", 1, 2),
    store1 = new Store("Store1", "Descpon tralala", 4, 7),
    store2 = new Store("Store2", "Descposdfgn tralala", 3, 5),
    appsArray = [app4, store1, store2, app2, app1c],
    device1 = new Device('hostname18888', appsArray);

// App class test
// app1a.release(7);
// app1a.release({ version: 7, description: 'desc new', rating: 1 });
...
store2.uploadApp(app1c);
store2.uploadApp(app3);
store2.uploadApp(app4);
// console.log(store1.apps);
// console.log('--------------------------------------');
// store1.takedownApp('App2');
// console.log(store1.apps);
// console.log(store1.apps);
// console.log('--------------------------------------');
// console.log(store1.search('app'));

// console.log(store1.listMostRecentApps());
// console.log(store1.listMostPopularApps());

// Device clas test

// console.log(device1.search('33'));
// console.log(device1.apps);
// console.log('--------------------------------------');
// device1.install('App4');
// device1.install('App4');
// device1.install('App1');
// console.log(device1.apps);
// console.log(device1.apps);
// console.log('--------------------------------------');
// device1.uninstall('App3')
// console.log(device1.apps);

// console.log(device1.listInstalled());
// console.log('--------------------------------------');
// device1.update();
// console.log(device1.listInstalled());